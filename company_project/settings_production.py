"""
Django settings for company_project project - PRODUCTION CONFIGURATION

This file contains production-ready settings with enhanced security.
Copy this to settings.py and configure environment variables for production.
"""
...
CSRF_TRUSTED_ORIGINS = get_env_variable('CSRF_TRUSTED_ORIGINS', 'https://localhost').split(',')
